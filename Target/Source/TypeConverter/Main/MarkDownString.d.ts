 ...
 */
export declare const FromAPI: (MarkdownStringInstance: VSCodeMarkdownString) => VSCodeIMarkdownString;
/**
 ...
 */
export declare const ToAPI: (MarkdownStringDTO: VSCodeIMarkdownString) => VSCodeMarkdownString;
