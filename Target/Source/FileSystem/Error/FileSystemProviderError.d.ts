 ...
 */
export declare function isFileSystemProviderError(
	error: unknown,
 ...
 */
export declare function isFileExistsError(
	error: unknown,
): error is FileExistsError;
/**
 * Check if an error is a PermissionError
 */
export declare function isPermissionError(
	error: unknown,
 ...
 */
export declare function isNotSupportedError(
	error: unknown,
): error is NotSupportedError;
/**
 * Check if an error is an UnknownFileSystemError
 */
export declare function isUnknownFileSystemError(
	error: unknown,
 ...
 */
export declare function toFileSystemProviderError(
	error: unknown,
	context: string,
	contextValue?: string,
