 ...
 */
export declare const MakeCreateItem: (
	ItemsRef: SubscriptionRef.SubscriptionRef<ReadonlyArray<ActivityBarItem>>,
	Telemetry: TelemetryService,
) => (Item: CreateActivityBarItem) => Effect.Effect<ActivityBarItem, never>;
/**
 * Creates the updateItem effect implementation.
 */
export declare const MakeUpdateItem: (
	ItemsRef: SubscriptionRef.SubscriptionRef<ReadonlyArray<ActivityBarItem>>,
 ...
 */
export declare const MakeRemoveItem: (
	ItemsRef: SubscriptionRef.SubscriptionRef<ReadonlyArray<ActivityBarItem>>,
	ActiveItemRef: SubscriptionRef.SubscriptionRef<string | undefined>,
	GetItem: (Id: string) => Effect.Effect<ActivityBarItem | undefined, never>,
	Telemetry: TelemetryService,
) => (Id: string) => Effect.Effect<void, ActivityBarItemNotFoundError>;
/**
 * Creates the getItem effect implementation.
 */
export declare const MakeGetItem: (
	ItemsRef: SubscriptionRef.SubscriptionRef<ReadonlyArray<ActivityBarItem>>,
) => (Id: string) => Effect.Effect<ActivityBarItem | undefined, never>;
/**
 * Creates the setActiveItem effect implementation.
 */
export declare const MakeSetActiveItem: (
	ActiveItemRef: SubscriptionRef.SubscriptionRef<string | undefined>,
	GetItem: (Id: string) => Effect.Effect<ActivityBarItem | undefined, never>,
	Telemetry: TelemetryService,
) => (Id: string) => Effect.Effect<void, ActivityBarItemNotFoundError>;
 ...
 */
export declare const MakeSetBadge: (
	UpdateItem: (
		Id: string,
		Updates: Partial<Omit<ActivityBarItem, "id">>,
	) => Effect.Effect<
 ...
 */
export declare const MakeGetBadge: (
	GetItem: (Id: string) => Effect.Effect<ActivityBarItem | undefined, never>,
) => (Id: string) => Effect.Effect<ActivityBarBadge | undefined, never>;
declare const _default: {
	MakeCreateItem: (
		ItemsRef: SubscriptionRef.SubscriptionRef<
