 ...
 */
export declare const TauriBaseLayer: Layer.Layer<never, never, unknown>;
/**
 ...
 */
export declare const TauriLiveLayer: Layer.Layer<never, unknown, unknown>;
/**
 * Tauri layer with maximum telemetry and logging.
 * Useful for debugging and development.
 */
export declare const TauriDevLayer: Layer.Layer<never, unknown, unknown>;
