 ...
 */
export declare const CreateNotAvailableError: (
	Reason: string,
) => ClipboardProblem;
/**
 ...
 * @returns A ClipboardProblem instance
 */
export declare const CreatePermissionDeniedError: (
	Reason: string,
) => ClipboardProblem;
/**
 ...
 * @returns A ClipboardProblem instance
 */
export declare const CreateFormatNotSupportedError: (
	Format: string,
) => ClipboardProblem;
/**
 ...
 * @returns A ClipboardProblem instance
 */
export declare const CreateSizeExceededError: (
	Size: number,
	Limit: number,
) => ClipboardProblem;
