...
export declare const ReadImage: Effect.Effect<never, IntegrationClipboardProblem, never>;
export declare const WriteImage: (_Image: Uint8Array) => Effect.Effect<void, IntegrationClipboardProblem>;
export declare const ReadResourceList: Effect.Effect<import("@codeeditorland/output/vs/workbench/workbench.web.main.internal.js").URI[], never, never>;
export declare const WriteResourceList: (_Resources: Uri[]) => Effect.Effect<void, IntegrationClipboardProblem>;
