...
declare const HostService_base: Effect.Service.Class<
	Host,
	"wind/HostService",
	{
		readonly effect: Effect.Effect<
			{
				...
				NotifyReady: () => Effect.Effect<
					void,
					HostServiceProblem,
					never
				>;
				Logger: (
					Arguments_0: LogLevel,
					Arguments_1: string,
				) => Effect.Effect<void, HostServiceProblem, never>;
				OnDidChangeWindowState: any;
				ShowTextDocument: (
					Arguments_0: VSCodeURI,
					Arguments_1: number | undefined,
					Arguments_2: IResolvedTextEditorOptions,
				) => Effect.Effect<string, HostServiceProblem, never>;
				ShowOpenDialog: (
					Arguments_0: INativeOpenDialogOptions,
				) => Effect.Effect<
					Option.Option<readonly VSCodeURI[]>,
					HostServiceProblem,
					never
				>;
				ShowSaveDialog: (
					Arguments_0: INativeSaveDialogOptions,
				) => Effect.Effect<
					Option.Option<VSCodeURI>,
					HostServiceProblem,
					never
				>;
				ShowSaveConfirm: (
					Arguments_0: VSCodeUriComponents[],
				) => Effect.Effect<
					ISaveDialogResult,
					HostServiceProblem,
					never
				...
				Stat: (
					Arguments_0: VSCodeURI,
				) => Effect.Effect<FileStat, HostServiceProblem, never>;
				ReadDirectory: (
					Arguments_0: VSCodeURI,
				) => Effect.Effect<
					[string, FileType][],
				...
				WriteFile: (
					Arguments_0: VSCodeURI,
					Arguments_1: Uint8Array<ArrayBufferLike>,
					Arguments_2: IFileWriteOptions,
				) => Effect.Effect<void, HostServiceProblem, never>;
				Delete: (
					Arguments_0: VSCodeURI,
					Arguments_1: IFileDeleteOptions,
				) => Effect.Effect<void, HostServiceProblem, never>;
				Rename: (
					Arguments_0: VSCodeURI,
					Arguments_1: VSCodeURI,
					Arguments_2: IFileOverwriteOptions,
				) => Effect.Effect<void, HostServiceProblem, never>;
				Copy: (
					Arguments_0: VSCodeURI,
					Arguments_1: VSCodeURI,
				...
				ShowNotification: (
					Arguments_0: INotification,
				) => Effect.Effect<void, HostServiceProblem, never>;
				ShowPrompt: (
					Arguments_0: Severity,
					Arguments_1: string,
					Arguments_2: IPromptChoice[],
					Arguments_3: any,
				) => Effect.Effect<void, HostServiceProblem, never>;
				ShowStatusMessage: (
					Arguments_0: NotificationMessage,
					Arguments_1: any,
				) => Effect.Effect<void, HostServiceProblem, never>;
				SetStatusBarItem: (
					Arguments_0: StatusBarEntryDTO,
				) => Effect.Effect<void, HostServiceProblem, never>;
				...
				SetWebviewOptions: (
					Arguments_0: string,
					Arguments_1: WebviewOptions,
				) => Effect.Effect<void, HostServiceProblem, never>;
				PostMessageToWebview: (
					Arguments_0: string,
					Arguments_1: any,
				) => Effect.Effect<boolean, HostServiceProblem, never>;
				SetWebviewTitle: (
					Arguments_0: string,
					Arguments_1: string,
				) => Effect.Effect<void, HostServiceProblem, never>;
				SetWebviewIconPath: (
					Arguments_0: string,
					Arguments_1: IconPathDTO | undefined,
				) => Effect.Effect<void, HostServiceProblem, never>;
				RevealWebviewPanel: (
					Arguments_0: string,
					Arguments_1: ShowOptionsDTO,
				) => Effect.Effect<void, HostServiceProblem, never>;
				DisposeWebview: (
					Arguments_0: string,
				) => Effect.Effect<void, HostServiceProblem, never>;
			...
			Error,
			import("../../Integration/Tauri/Service.js").Integration
		>;
	}
>;
/**
