...
declare const HostService_base: Effect.Service.Class<Host, "wind/HostService", {
    readonly effect: Effect.Effect<{
        ...
        ShowTextDocument: (Arguments_0: VSCodeURI, Arguments_1: number | undefined, Arguments_2: IResolvedTextEditorOptions) => Effect.Effect<string, HostServiceProblem, never>;
        ShowOpenDialog: (Arguments_0: INativeOpenDialogOptions) => Effect.Effect<Option.Option<readonly VSCodeURI[]>, HostServiceProblem, never>;
        ShowSaveDialog: (Arguments_0: INativeSaveDialogOptions) => Effect.Effect<Option.Option<VSCodeURI>, HostServiceProblem, never>;
        ShowSaveConfirm: (Arguments_0: VSCodeUriComponents[]) => Effect.Effect<ISaveDialogResult, HostServiceProblem, never>;
        OpenFile: (Arguments_0: VSCodeURI) => Effect.Effect<void, HostServiceProblem, never>;
        Stat: (Arguments_0: VSCodeURI) => Effect.Effect<FileStat, HostServiceProblem, never>;
        ReadDirectory: (Arguments_0: VSCodeURI) => Effect.Effect<[string, FileType][], HostServiceProblem, never>;
        CreateDirectory: (Arguments_0: VSCodeURI) => Effect.Effect<void, HostServiceProblem, never>;
        ReadFile: (Arguments_0: VSCodeURI) => Effect.Effect<Uint8Array<ArrayBufferLike>, HostServiceProblem, never>;
        WriteFile: (Arguments_0: VSCodeURI, Arguments_1: Uint8Array<ArrayBufferLike>, Arguments_2: IFileWriteOptions) => Effect.Effect<void, HostServiceProblem, never>;
        Delete: (Arguments_0: VSCodeURI, Arguments_1: IFileDeleteOptions) => Effect.Effect<void, HostServiceProblem, never>;
        Rename: (Arguments_0: VSCodeURI, Arguments_1: VSCodeURI, Arguments_2: IFileOverwriteOptions) => Effect.Effect<void, HostServiceProblem, never>;
        Copy: (Arguments_0: VSCodeURI, Arguments_1: VSCodeURI, Arguments_2: IFileOverwriteOptions) => Effect.Effect<void, HostServiceProblem, never>;
