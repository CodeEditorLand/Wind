...
export declare class WebViewPanelImplementation implements WebviewPanel {
    ...
    constructor(Handle: string, Host: HostService, Extension: IExtensionDescription, OnDidDisposeCallback: () => void, InitialViewType: string, InitialTitle: string, InitialOptions: WebviewPanelOptions & WebviewOptions, InitialViewColumn: ViewColumn);
