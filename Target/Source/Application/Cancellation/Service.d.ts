...
declare const CancellationService_base: Effect.Service.Class<Cancellation, "Service/Cancellation", {
    readonly sync: () => {
        CancelToken: (_TokenId: number) => Effect.Effect<void, never, never>;
    };
}>;
/**
