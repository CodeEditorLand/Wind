...
declare const DialogService_base: Effect.Service.Class<Dialog, "Service/Dialog", {
    readonly effect: Effect.Effect<{
        ShowOpenDialog: (Options?: OpenDialogOptions) => Effect.Effect<readonly VSCodeURI[] | undefined, DialogProblem, never>;
        ShowSaveDialog: (Options?: SaveDialogOptions) => Effect.Effect<any, DialogProblem, never>;
