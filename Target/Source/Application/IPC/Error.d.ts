 ...
 */
declare const GrpcConnectionProblem_base: new <
...
declare const IpcProblem_base: new <A extends Record<string, any> = {}>(
	args: import("effect/Types").Equals<A, {}> extends true
		? void
		: { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P] },
) => import("effect/Cause").YieldableError & {
...
declare const ProtoSerializationProblem_base: new <
	A extends Record<string, any> = {},
>(
	args: import("effect/Types").Equals<A, {}> extends true
		? void
