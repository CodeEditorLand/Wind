...
import { Disposable, type Breakpoint, type BreakpointsChangeEvent, type DebugAdapterDescriptorFactory, type DebugAdapterTrackerFactory, type DebugConfiguration, type DebugConfigurationProvider, type DebugConfigurationProviderTriggerKind, type DebugConsole, type DebugSession, type DebugSessionCustomEvent, type DebugSessionOptions, type Event, type WorkspaceFolder } from "vscode";
...
export interface Debug {
    ...
    readonly registerDebugConfigurationProvider: (type: string, provider: DebugConfigurationProvider, trigger: DebugConfigurationProviderTriggerKind, extension: IExtensionDescription) => Effect.Effect<Disposable, DebugProviderRegistrationProblem>;
...
declare const DebugService_base: Effect.Service.Class<Debug, "Service/Debug", {
    readonly effect: Effect.Effect<Debug, never, import("../IPC/Service.js").IPC>;
}>;
/**
