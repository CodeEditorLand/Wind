...
const PanelLive = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const ActiveViewRef = yield* SubscriptionRef.make(
      void 0
    );
    ...
    const UpdateView = /* @__PURE__ */ __name((Id, updates) => Effect.gen(function* () {
      ...
      try {
        yield* SubscriptionRef.modify(ViewsRef, (Views2) => [
          void 0,
          Views2.map(
            (View) => View.id === Id ? { ...View, ...updates } : View
    ...
    const GetView = /* @__PURE__ */ __name((Id) => Effect.map(
      ViewsRef.get,
      (Views2) => Views2.find((View) => View.id === Id)
    ), "GetView");
    ...
    const SetActiveView = /* @__PURE__ */ __name((Id) => Effect.gen(function* () {
      ...
      yield* SubscriptionRef.modify(ViewsRef, (Views2) => [
        void 0,
        Views2.map(
          (View) => View.id === Id ? { ...View, visible: true, maximized: false } : View
        )
      ]);
    ...
    const MaximizeView = /* @__PURE__ */ __name((Id) => Effect.gen(function* () {
      yield* SubscriptionRef.modify(ViewsRef, (Views2) => [
        void 0,
        Views2.map(
          (View) => View.id === Id ? { ...View, maximized: true } : { ...View, maximized: false }
        )
      ]);
      yield* TelemetryService.log(
        "info",
    ...
    const GetViewsByType = /* @__PURE__ */ __name((Type) => Effect.map(
      Views,
      (Views2) => Views2.filter((View) => View.type === Type)
    ), "GetViewsByType");
