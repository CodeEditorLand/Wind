  ...
  Effect.gen(function* () {
    ...
    const CreateItem = /* @__PURE__ */ __name((Item) => Effect.gen(function* () {
      ...
      yield* SubscriptionRef.modify(ItemsRef, (Items2) => [
        void 0,
        [...Items2, NewItem].sort((a, b) => a.priority - b.priority)
      ]);
    ...
    const GetItem = /* @__PURE__ */ __name((Id) => Effect.map(
      ItemsRef.get,
      (Items2) => Items2.find((Item) => Item.id === Id)
    ), "GetItem");
