...
class WorkbenchIntegrationTag extends Context.Tag(
...
const WorkbenchIntegrationServiceLive = Effect.gen(function* () {
  ...
  const workspaceContextRef = yield* Ref.make(
    void 0
  );
  ...
  const registerProvider = /* @__PURE__ */ __name((scheme) => Effect.gen(function* () {
    ...
    const vscodeProvider = {
      ...
      copy: /* @__PURE__ */ __name((sourceStr, destinationStr) => provider.copy(
        URI.parse(sourceStr),
        URI.parse(destinationStr)
      ), "copy"),
      move: /* @__PURE__ */ __name((sourceStr, destinationStr) => provider.move(
        URI.parse(sourceStr),
        URI.parse(destinationStr)
      ), "move"),
      readdir: /* @__PURE__ */ __name((uriStr) => provider.readdir(URI.parse(uriStr)), "readdir"),
      mkdir: /* @__PURE__ */ __name((uriStr, options) => provider.mkdir(URI.parse(uriStr), {
