...
export declare class ContentHoverWidget extends ResizableContentWidget {
    ...
    readonly onDidResize: import("../../../../workbench/workbench.web.main.internal.js").Event<void>;
    private readonly _onDidScroll;
    readonly onDidScroll: import("../../../../workbench/workbench.web.main.internal.js").Event<ScrollEvent>;
