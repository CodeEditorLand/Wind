export declare namespace AccessibilityHelpNLS {
    ...
    const defaultWindowTitleIncludesEditorState: string;
    const defaultWindowTitleExcludingEditorState: string;
    ...
    const acceptSuggestAction: string;
    const toggleSuggestionFocus: string;
    ...
    const chatEditorModification: string;
    const chatEditorRequestInProgress: string;
    const chatEditActions: string;
}
