...
export declare abstract class EditorWorkerService extends Disposable implements IEditorWorkerService {
    ...
    constructor(workerDescriptor: IWebWorkerDescriptor, modelService: IModelService, configurationService: ITextResourceConfigurationService, logService: ILogService, _languageConfigurationService: ILanguageConfigurationService, languageFeaturesService: ILanguageFeaturesService);
    dispose(): void;
...
export declare class EditorWorkerClient extends Disposable implements IEditorWorkerClient {
    ...
    private _disposed;
    constructor(_workerDescriptorOrWorker: IWebWorkerDescriptor | Worker, keepIdleModels: boolean, modelService: IModelService);
    fhr(method: string, args: any[]): Promise<any>;
