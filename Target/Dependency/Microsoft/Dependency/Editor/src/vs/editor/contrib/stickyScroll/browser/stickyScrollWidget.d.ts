...
export declare class StickyScrollWidget extends Disposable implements IOverlayWidget {
    ...
    readonly onDidChangeStickyScrollHeight: import("../../../../workbench/workbench.web.main.internal.js").Event<{
        height: number;
    }>;
...
declare class RenderedStickyLine {
    ...
    constructor(index: number, lineNumber: number, lineDomNode: HTMLElement, lineNumberDomNode: HTMLElement, foldingIcon: StickyFoldingIcon | undefined, characterMapping: CharacterMapping, scrollWidth: number, height: number);
}
