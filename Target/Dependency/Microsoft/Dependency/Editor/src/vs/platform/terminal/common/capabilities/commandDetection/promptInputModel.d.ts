...
export declare class PromptInputModel extends Disposable implements IPromptInputModel {
    ...
    readonly onDidInterrupt: Event<IPromptInputModelState>;
    constructor(_xterm: Terminal, onCommandStart: Event<ITerminalCommand>, onCommandStartChanged: Event<void>, onCommandExecuted: Event<ITerminalCommand>, _logService: ILogService);
