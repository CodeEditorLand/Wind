...
export declare class ConfigurationModel implements IConfigurationModel {
    ...
    constructor(_contents: any, _keys: string[], _overrides: IOverrides[], raw: IStringDictionary<any> | ReadonlyArray<IStringDictionary<any> | ConfigurationModel> | undefined, logService: ILogService);
