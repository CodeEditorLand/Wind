...
export declare class MenuId {
    ...
    static readonly SCMHistoryItemChatContext: MenuId;
    ...
    static readonly ChatModelPicker: MenuId;
    ...
    static readonly ChatExplorerMenu: MenuId;
    static readonly ChatTextEditorMenu: MenuId;
    static readonly ChatTerminalMenu: MenuId;
