...
export declare function getExperimentalExtensionToggleData(contextKeyService: IContextKeyService, extensionGalleryService: IExtensionGalleryService, productService: IProductService): Promise<ExtensionToggleData | undefined>;
/**
