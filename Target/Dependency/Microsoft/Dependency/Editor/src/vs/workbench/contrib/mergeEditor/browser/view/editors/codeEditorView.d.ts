...
export declare abstract class CodeEditorView extends Disposable {
    ...
    readonly model: IObservable<import("../../model/mergeEditorModel.js").MergeEditorModel | undefined>;
    ...
    readonly cursorPosition: IObservable<import("../../../../../../editor/common/core/position.js").Position | null>;
