 ...
 */
export declare const testsInFile: (testService: ITestService, ident: IUriIdentityService, uri: URI, waitForIdle?: boolean, descendInFile?: boolean) => AsyncIterable<IncrementalTestCollectionItem>;
/**
