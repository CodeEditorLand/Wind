...
export declare abstract class AbstractUserDataProfileElement extends Disposable {
    ...
    readonly onDidChange: import("../../../workbench.web.main.internal.js").Event<ChangeEvent>;
...
export declare class UserDataProfilesEditorModel extends EditorModel {
    ...
    readonly onDidChange: import("../../../workbench.web.main.internal.js").Event<AbstractUserDataProfileElement | undefined>;
    private templates;
