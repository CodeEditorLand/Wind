...
export declare const IDynamicAuthenticationProviderStorageService: import("../../../../platform/instantiation/common/instantiation.js").ServiceIdentifier<IDynamicAuthenticationProviderStorageService>;
