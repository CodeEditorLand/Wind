...
export declare class TimelineService extends Disposable implements ITimelineService {
    ...
    readonly onDidChangeProviders: import("../../../workbench.web.main.internal.js").Event<TimelineProvidersChangeEvent>;
    private readonly _onDidChangeTimeline;
    readonly onDidChangeTimeline: import("../../../workbench.web.main.internal.js").Event<TimelineChangeEvent>;
    private readonly _onDidChangeUri;
    readonly onDidChangeUri: import("../../../workbench.web.main.internal.js").Event<URI>;
