...
export declare class TerminalChatWidget extends Disposable {
    ...
    }, contextKeyService: IContextKeyService, _chatService: IChatService, _storageService: IStorageService, _viewsService: IViewsService, instantiationService: IInstantiationService, _chatAgentService: IChatAgentService);
    private _dimension?;
    private _relayout;
    private _doLayout;
