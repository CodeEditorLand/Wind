...
export declare class SimpleSuggestDetailsWidget {
    ...
    private _size;
    constructor(_getFontInfo: () => ISimpleSuggestWidgetFontInfo, onDidFontInfoChange: Event<void>, _getAdvancedExplainModeDetails: () => string | undefined, instaService: IInstantiationService);
...
export declare class SimpleSuggestDetailsOverlay {
    ...
    private _userSize?;
    private _topLeft?;
    constructor(widget: SimpleSuggestDetailsWidget, _container: HTMLElement);
    dispose(): void;
    getId(): string;
