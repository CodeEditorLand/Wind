...
export declare class TerminalViewPane extends ViewPane {
    ...
    constructor(options: IViewPaneOptions, keybindingService: IKeybindingService, _contextKeyService: IContextKeyService, viewDescriptorService: IViewDescriptorService, _configurationService: IConfigurationService, _contextMenuService: IContextMenuService, _instantiationService: IInstantiationService, _terminalService: ITerminalService, _terminalConfigurationService: ITerminalConfigurationService, _terminalGroupService: ITerminalGroupService, themeService: IThemeService, hoverService: IHoverService, _notificationService: INotificationService, _keybindingService: IKeybindingService, openerService: IOpenerService, _menuService: IMenuService, _terminalProfileService: ITerminalProfileService, _terminalProfileResolverService: ITerminalProfileResolverService, _themeService: IThemeService, _accessibilityService: IAccessibilityService);
