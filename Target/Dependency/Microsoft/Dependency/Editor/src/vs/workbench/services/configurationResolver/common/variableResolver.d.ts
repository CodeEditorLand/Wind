...
export declare abstract class AbstractVariableResolverService implements IConfigurationResolverService {
    ...
    resolveWithInteractionReplace(folder: IWorkspaceFolderData | undefined, config: any): Promise<any>;
    resolveWithInteraction(folder: IWorkspaceFolderData | undefined, config: any): Promise<Map<string, string> | undefined>;
