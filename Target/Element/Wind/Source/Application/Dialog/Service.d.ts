...
declare const DialogService_base: Effect.Service.Class<Dialog, "Service/Dialog", {
    readonly effect: Effect.Effect<{
        ShowOpenDialog: (Options?: OpenDialogOptions) => Effect.Effect<readonly import("vs/workbench/workbench.web.main.internal.js").URI[] | undefined, DialogProblem, never>;
        ShowSaveDialog: (Options?: SaveDialogOptions) => Effect.Effect<import("vs/workbench/workbench.web.main.internal.js").URI | undefined, DialogProblem, never>;
