...
declare const TextEditorService_base: Effect.Service.Class<VSCodeTextFileService, "textFileService", {
    readonly effect: Effect.Effect<VSCodeTextFileService, unknown, unknown>;
}>;
/**
