...
export interface TerminalService {
	readonly CreateTerminal: (options?: {
		...
		readonly cwd?: string;
	}) => Effect.Effect<{ readonly id: number; readonly name: string }, TerminalProblem>;

	readonly SendText: (id: number, text: string) => Effect.Effect<void, TerminalProblem>;

	readonly Dispose: (id: number) => Effect.Effect<void, TerminalProblem>;

	readonly Show: (id: number, preserveFocus?: boolean) => Effect.Effect<void, TerminalProblem>;
