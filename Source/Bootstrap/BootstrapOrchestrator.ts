...
export class BootstrapOrchestrator {
	...
	private initializeStages(): void {
		this.stages = [
			...
			{
				name: "MountainIntegration",
				execute: () => this.executeMountainIntegration(),
			},
	...
	private async executeMountainIntegration(): Promise<StageResult> {
		...
		try {
			console.log(
				"[BootstrapOrchestrator] 🔗 Starting Mountain integration...",
			);
			...
			console.log(
				"[BootstrapOrchestrator] ✅ Mountain integration completed successfully",
			);
			...
			const duration = performance.now() - startTime;
			console.error(
				"[BootstrapOrchestrator] ❌ Mountain integration failed:",
				error,
			);
			...
			return {
				...
				warnings: [
					"Mountain integration failed - continuing with basic functionality",
				],
			};
		}
	}
