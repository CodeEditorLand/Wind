...
This document tracks all missing implementations required for full VSCode
workbench integration with Tauri/Wind/Sky ecosystem.
...
6. **Workbench UI Parts** - Titlebar, Activitybar, Sidebar, Editor, Panel,
   Statusbar
