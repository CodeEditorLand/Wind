...
export interface StatusBarService {
	...
	readonly createItem: (item: CreateStatusBarItem) => StatusBarItem;
	...
	readonly getItem: (id: string) => StatusBarItem | undefined;
	...
	readonly getItemText: (id: string) => string | undefined;
