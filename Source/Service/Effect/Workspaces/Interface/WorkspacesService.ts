...
export interface WorkspacesService {
	readonly GetFolders: () => Promise<readonly WorkspaceFolder[]>;
	...
	readonly RemoveFolder: (uri: string) => Promise<void>;

	readonly GetName: () => Promise<string | undefined>;
	 ...
	 * Cocoon.
	 */
	readonly OnChange: () => ReadableStream<WorkspacesChangeEvent>;
}
