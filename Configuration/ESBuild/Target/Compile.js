...
var On2, Bundle2, Compile2, Merge, Target_default;
var init_Target = __esm({
  async "Source/Configuration/ESBuild/Target.ts"() {
    "use strict";
    On2 = (await init_Wind().then(() => Wind_exports)).On;
    Bundle2 = (await init_Wind().then(() => Wind_exports)).Bundle;
    Compile2 = (await init_Wind().then(() => Wind_exports)).Compile;
    Merge = (await Promise.resolve().then(() => (init_dist(), dist_exports))).deepmerge;
    Target_default = /* @__PURE__ */ __name(async (Current) => Merge(
...
// Source/Configuration/ESBuild/Target/Compile.ts
var On3 = (await init_Wind().then(() => Wind_exports)).On;
var Bundle3 = (await init_Wind().then(() => Wind_exports)).Bundle;
var Merge2 = (await Promise.resolve().then(() => (init_dist(), dist_exports))).deepmergeCustom({
  mergeArrays: false
});
var Compile_default = /* @__PURE__ */ __name(async (Current) => Merge2(
  await (await init_Target().then(() => Target_exports)).default(Current),
  {
    bundle: true,
    outbase: "Target",
